...
class ProgramData extends Content
{
    public function __construct(
        ...
        public readonly ?string $completionCriteria = null,
    ) {
        parent::__construct(
            $id,
            $fullname,
    ...
    public static function fromApiResponse(array $data, ?string $apiVersion = null): self
    {
        ...
        return new self(
            ...
            contentType: $dataCopy['contenttype'] ?? 'program',
            url: $dataCopy['url'] ?? '',
            ...
            courses: $dataCopy['courses'] ?? null,
            completionCriteria: $dataCopy['completion_criteria'] ?? null,
        );
    }
}
