...
class VideoData extends Content
{
    ...
    public static function fromApiResponse(array $data, ?string $apiVersion = null): self
    {
        ...
        return new self(
            ...
            contentType: $dataCopy['contenttype'] ?? 'video',
            url: $dataCopy['url'] ?? '',
            ...
            // Video-specific data
            videoUrl: $dataCopy['video_url'] ?? null,
            videoDuration: $dataCopy['video_duration'] ?? null,
            videoProvider: $dataCopy['video_provider'] ?? null,
        );
    }
}
